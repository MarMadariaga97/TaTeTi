...
public class FramePresentacion {
	...
	public FramePresentacion(Juego j) {
		...
		lblfondo = new JLabel(new ImageIcon("src/imagenes/fondo.png"));
		...
		J1.setForeground(new Color(128, 0, 255));
		...
		J2.setForeground(new Color(128, 0, 255));
		...
		textFieldJ1.setFont(new Font("Candara", Font.PLAIN, 12));
		textFieldJ1.setBackground(new Color(255, 255, 255));
		textFieldJ1.setBounds(75, 323, 96, 19);
		textFieldJ1.setColumns(10);
		
		textFieldJ2 = new JTextField();
		textFieldJ2.setFont(new Font("Candara", Font.PLAIN, 12));
		textFieldJ2.setBackground(new Color(255, 255, 255));
		...
		btnJugar.setForeground(new Color(128, 128, 255));
